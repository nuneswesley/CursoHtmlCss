...
<html>
    ...
    <body>
        ...
        <p>
            ...
            se tiver dúvidas. Conheça também nossa <a href="#historia"><em>história</em></a> e nossos <a href="#diferencias">diferenciais </a>.
        </p>
        ...
        <ul>
        	...
        	<li>Se você achar um loja mais barata, leva o produto de graça</li>
        	<li>Pague em reais, dólares, euros ou bitcoins</li>
        	<li>Todas as compras compras com frete grátis para todo Brasil</li>
        	<li>Maior comércio eletrônico de moda do mundo</li>
        	<li>Atendimento vvia telefone, email, chat, twitter, facebook, carta, faz e telegrama</li>
